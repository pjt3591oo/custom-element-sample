...
function TableBody(_state) {
  return class extends HTMLElement {
    ...
    disconnectedCallback() {
      // 이벤트 바인딩 해제
      this.inputEvents.forEach(input => input.removeEventListener(this.onChangeHandler));
...
customElements.define('check-table', TableBody(state));
